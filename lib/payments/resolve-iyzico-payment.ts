    ...
    if (client && expert) {
      ...
      await Promise.all([
        createNotification({
          ...
          title: 'Görüşmeniz başladı',
          message: `Ödemeniz onaylandı. ${expert.name || 'Uzmanınız'} ile görüşme alanınız aktif.`,
          type: 'payment',
        ...
        createNotification({
          ...
          title: 'Görüşmeniz başladı',
          message: `${client.name || 'Danışanınız'} ödemeyi tamamladı. Görüşme alanınız aktif.`,
          type: 'payment',
